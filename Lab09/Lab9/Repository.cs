...
namespace Lab9
{
    ...
    public class Topic
    {
        ...
        {
            Topic o = obj as Topic;
            if (o != null)
            {
                return this.Id.Equals(o.Id) || this.Id.Equals(o.Name);
            }
            return false;
        }
        public override string ToString()
    ...
    public class StudentWithTopics
    {
        ...
        public override string ToString()
        {
            var result = $"{Id,2}) {Index,5}, {Name,11}, {Gender,6},{(Active ? "active" : "no active"),9},{DepartmentId,2}, topics Ids: ";
            foreach (var str in Topics)
                result += str + ", ";
            return result;
        }
